...
def delegate_to_agent(prompt: str, model: str = "sonnet", timeout: int = 600, skip_permissions: bool = False, thinking_budget: int = None, agent_role: str = "rick", team_id: Optional[str] = None, task_budget: Optional[int] = None) -> str:
...
def cmd_delegate(args):
    ...
    # Execute
    try:
        output = delegate_to_agent(prompt, model=model, timeout=args.timeout, thinking_budget=thinking_budget, agent_role=agent, team_id=team_id, task_budget=task_budget)
